...
/**
 * get_string - convert  number to string
...
/**
 * abs_value - gets the absolute value of an integer
 * @i: integer to get absolute value of
 *
 * Return: unsigned integer abs rep of i
 */
unsigned int abs_value(int i)
{
	if (i < 0)
...
/**
 * get_len_base - gets length of buffer needed for an unsigned int
